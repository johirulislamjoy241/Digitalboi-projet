...
export async function PATCH(req) {
  ...
  try {
    ...
    if (body.biz_category !== undefined) update.biz_category = body.biz_category;
    if (body.website      !== undefined) update.website      = body.website;
    if (body.social_link  !== undefined) update.social_link  = body.social_link;
    if (body.trade_license!== undefined) update.trade_license= body.trade_license;
