...
export default function DashboardPage({ user, setActive }) {
  ...
  const stats = [
    ...
    { label:"মাসের বিক্রয়",  value: taka(data?.monthTotal||0),   color:T.success, icon:"trending", bg:`${T.success}12` },
    { label:"মোট বাকি",      value: taka(data?.totalDue||0),     color:T.warning, icon:"alert",   bg:`${T.warning}12` },
    { label:"আজকের অর্ডার",  value: data?.todayOrders||0,        color:T.info,    icon:"receipt", bg:`${T.info}12` },
  ];
