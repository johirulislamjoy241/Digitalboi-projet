...
function AuthGate() {
  ...
  if (loading) return (
    <div className="loader-screen">
      ...
      <div style={{ fontSize: '0.72rem', color: 'var(--text3)', fontFamily: 'var(--font-bn)', marginTop: -6 }}>লোড হচ্ছে...</div>
      <div className="loader-bar" style={{ marginTop: 8 }}><div className="loader-bar-fill" /></div>
    </div>
  )
