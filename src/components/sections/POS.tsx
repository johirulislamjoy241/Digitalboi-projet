...
export default function POSSection() {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',height:'calc(100dvh - var(--topbar-h) - var(--nav-h) - env(safe-area-inset-bottom))',overflow:'hidden',margin:'-16px',width:'calc(100% + 32px)'}}>

      {showCam&&<CameraScanner onScan={onScan} onClose={()=>setShowCam(false)}/>}

      {/* ── Search Row ── */}
      <div style={{display:'flex',alignItems:'center',gap:7,padding:'8px 12px 6px',flexShrink:0,background:'var(--bg)',overflow:'hidden'}}>
        {/* Search */}
